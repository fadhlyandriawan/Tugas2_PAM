    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_hitung.setOnClickListener {
            if (et_nilai1.text.toString() == "") {
                et_nilai1.error = "Angka 1 Wajib di-isi"
                return@setOnClickListener
            }

            if (et_nilai2.text.toString() == "") {
                et_nilai2.error = "Angka 2 Wajib di-isi"
                return@setOnClickListener
            }

            val nilai_angka1 = et_nilai1.text.toString().toInt()
            val nilai_angka2 = et_nilai2.text.toString().toInt()
